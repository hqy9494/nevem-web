...
export class PurchaseReturns extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (getPurchaseDetails && getPurchaseDetails[this.uuid]) {
      // console.log(getPurchaseDetails[this.uuid],"getPurchaseDetails")
      this.setState({
  ...
  render() {
    ...
    return <section className="PurchaseReturns-page">
      <div className="project-title">退货列表</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(PurchaseReturns);
