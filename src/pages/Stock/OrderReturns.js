...
export class OrderReturns extends React.Component {
...
//      },
    ...
    return (
      <section className="OrderReturns-page">
        <TableExpand
          {...config}
          path={`${this.props.match.path}`}
          replace={this.props.replace}
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderReturns);
