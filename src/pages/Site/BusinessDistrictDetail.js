...
export class BusinessDistrictDetail extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
    this.uuid = uuid.v1();
...
export default connect(mapStateToProps, mapDispatchToProps)(BusinessDistrictDetail);
